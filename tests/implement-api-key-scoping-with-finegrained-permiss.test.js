...
describe('API Key Fine-Grained Permission Scoping', () => {
  ...
  describe('Scope Validator Utility', () => {
    ...
    describe('hasScope', () => {
      ...
      it('should grant all permissions with admin wildcard', () => {
        const scopes = ['admin:*'];
        expect(scopeValidator.hasScope(scopes, 'donations:read')).toBe(true);
    ...
    describe('hasAllScopes', () => {
      ...
      it('should use wildcard for matching', () => {
    ...
    describe('getScopesByResource', () => {
      it('should return scopes for specific resource', () => {
  ...
  describe('API Key Creation with Scopes', () => {
    ...
    it('should reject key creation with duplicate scopes', async () => {
      const response = await request(app)
        .post('/api/v1/api-keys')
        .set('x-api-key', adminKey)
        .send({
    ...
    it('should reject key creation with non-array scopes', async () => {
      const response = await request(app)
        .post('/api/v1/api-keys')
        .set('x-api-key', adminKey)
        .send({
  ...
  describe('API Key Model Scope Persistence', () => {
    ...
    it('should list keys with scopes', async () => {
  ...
  describe('Scope Permission Enforcement', () => {
    ...
    it('should allow operation with matching scope', async () => {
  ...
  describe('Scope Edge Cases and Validation', () => {
    ...
    it('should reject scope with wrong format', async () => {
  ...
  describe('Scope Audit Logging', () => {
    it('should log key creation with scopes', async () => {
      const response = await request(app)
        .post('/api/v1/api-keys')
        .set('x-api-key', adminKey)
        .send({
  ...
  describe('Scope Deprecation and Revocation', () => {
    it('should preserve scopes after deprecation', async () => {
      const keyInfo = await apiKeysModel.createApiKey({
    ...
    it('should return null for revoked key (scopes not accessible)', async () => {
      const keyInfo = await apiKeysModel.createApiKey({
  ...
  describe('Scope Compatibility', () => {
    it('should be compatible with existing keys without scopes', async () => {
