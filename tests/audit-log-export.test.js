...
describe('API Key Audit Log Export', () => {
  ...
  describe('countAuditLogs', () => {
    test('should count audit logs for API key', async () => {
  ...
  describe('queryAuditLogs', () => {
    test('should query audit logs with pagination', async () => {
      const mockLogs = [
        {
          id: 1,
  ...
  describe('updateExportStatus', () => {
    ...
    test('should update status with file path', async () => {
      Database.run.mockResolvedValue({});
    ...
    test('should update status with error message', async () => {
      Database.run.mockResolvedValue({});
  ...
  describe('initiateExport', () => {
    test('should initiate synchronous export for small datasets', async () => {
    ...
    test('should initiate asynchronous export for large datasets', async () => {
  ...
  describe('CSV format validation', () => {
    test('should produce valid CSV with all fields', () => {
      const logs = [
        {
          id: 1,
          timestamp: '2024-01-15T10:30:00.000Z',
