...
describe('CorporateMatchingService', () => {
  ...
  describe('processCorporateMatching', () => {
    ...
    test('should create matching donation for enrolled employee', async () => {
      const donation = {
        id: 'test-donation-1',
        amount: 50.0,
        senderId: 2
    ...
    test('should not match for non-enrolled employees', async () => {
      const results = await CorporateMatchingService.processCorporateMatching({
        id: 'test-donation-1',
        amount: 50.0,
  ...
  describe('getEmployeePrograms', () => {
    test('should return active programs for enrolled employee', async () => {
      const program = await CorporateMatchingService.create({
        sponsor_id: 1,
        match_ratio: 1.0,
        per_employee_limit: 100.0,
  ...
  describe('getEmployeeYearMatched', () => {
    test('should return matched amount for employee in program for year', async () => {
      const program = await CorporateMatchingService.create({
        sponsor_id: 1,
        match_ratio: 1.0,
        per_employee_limit: 100.0,
