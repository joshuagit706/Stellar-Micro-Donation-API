...
describe('Stellar Account Signer Management', () => {
  ...
  describe('getSigners', () => {
    test('should return all signers for an account', async () => {
  ...
  describe('addSigner', () => {
    test('should add a signer with correct weight', async () => {
    ...
    test('should default to weight 1 if not specified', async () => {
      const result = await stellarService.addSigner(
        'SXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX',
        'GAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA'
      );
